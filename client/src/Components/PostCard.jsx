            ...
            <div className="h-1/3 p-3 flex flex-col justify-between bg-white dark:bg-gray-900">
                ...
                <div className="mt-auto">
                    <div className="flex items-center justify-between">
                        ...
                        {/* Read more arrow */}
                        <div className="text-blue-600 dark:text-blue-400 opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-x-2 group-hover:translate-x-0">
